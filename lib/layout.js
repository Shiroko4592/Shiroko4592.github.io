  ...
  const docTools = currentTitle
    ? html`
        ...
        <ul>
          ...
          <li><a href="/move/${currentTitle}">이동</a></li>
...
<header class="topbar">
  <div class="topbar-inner">
    ...
    <nav class="topnav">
      <a href="/RecentChanges">편집 내역</a>
      <a href="/RandomPage">랜덤</a>
      ${raw(currentUser
        ? html`<a class="topnav-user" href="/w/${USER_NS + (currentUser.displayName || currentUser.phone)}">${currentUser.displayName || currentUser.phone}</a>
               <form method="post" action="/logout" class="topnav-logout">
                 <button type="submit">로그아웃</button>
               </form>`
        : html`<a href="/login">로그인</a>
               <a class="topnav-signup" href="/signup">회원가입</a>`)}
    </nav>
  </div>
</header>
...
<div class="container">
  <aside class="sidebar">
    ...
    <ul>
      ...
      <li><a href="/RecentChanges">편집 내역</a></li>
